<div id="printTable" >
	...
	<p style="text-align: center;"><strong>Top 10 Students&nbsp;</strong></p>
	...
	<td style="width: 188px; text-align: center; height: 18px;"><strong>Rank</strong></td>
	<td style="width: 206px; text-align: center; height: 18px;"><strong>Name</strong></td>
	</tr>
	@foreach($data as $key=>$data)
	<tr style="height: 18px;">
	<td style="width: 188px; height: 18px;">&nbsp;{{$key+1}}</td>
	<td style="width: 206px; height: 18px;">&nbsp;{{$data->last_name}}, {{$data->first_name}}</td>
	</tr>
	@endforeach
	</tbody>
	</table>
