...
<div id="printTable" >
	<div style="width: 100%;">
	<p>NAME: <strong>{{ucwords($student->last_name)}}, {{ucwords($student->first_name)}}</strong><strong style="float: right"> Grade: {{ucwords($student->title)}}-{{$student->section}}</strong></p>
	...
	<p style="text-align: justify;"><strong>Books Fee:</strong> <strong style="float: right">P {{ number_format($payment->books, 2, '.', ',') }}</strong><br />
		<strong>Uniform/P.E. Fee:</strong><strong style="float: right">P {{ number_format($payment->uniform, 2, '.', ',') }}</strong><br />
		<strong>PTA:</strong> <strong style="float: right">P {{ number_format($payment->pta, 2, '.', ',') }}</strong><br />
		<strong>Others Fee:</strong> <strong style="float: right">P {{ number_format($payment->past_balance, 2, '.', ',') }}</strong><br />
	<h2 style="text-align: justify;"><strong>Total:</strong><strong style="float: right">P {{ number_format($payment->books + $payment->uniform + $payment->pta + $payment->past_balance, 2, '.', ',') }}</strong></h2></p>
	<table style="height: 153px; width: 100%;" border="1" cellspacing="0">
	<tbody>
	<tr>
	<td style="width: 64px; text-align: center;"><strong>Date</strong></td>
	...
	<div style="width: 49%;float: left;border: solid black 2px;">
		<p style="float: left"> &nbsp;Student/Parent Copy</p><br><br>
		<p style="text-align: center;"><font size="1">Community Welfare Service Lotus Foundation <br>
			<b>School and Training Center</b></font></p>
	...
	<div style="width: 49%;float: right;border: solid black 2px;">
		<p style="float: left"> &nbsp;School Copy</p><br><br>
		<p style="text-align: center;"><font size="1">Community Welfare Service Lotus Foundation <br>
			<b>School and Training Center</b></font></p>
		<p style="text-align: center;"><font size="1">
			Gredu, Panabo City, Davao del Norte <br>
