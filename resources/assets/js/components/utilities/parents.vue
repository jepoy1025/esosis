          ...
          <div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"><b class="pink">Parents</b> List</h3>
              </div>
              <!-- /.card-header -->
...
<script>
    export default {
        ...
        methods: {
            studentsList(id){
                axios.get("/api/parentsStudents/" + id).then(({data})=>(this.students = data.data));
                $('#studentsModal').modal('show');
            },
            loadUser(){
                axios.get("api/parents").then(({data})=>(this.users = data.data));
            },
