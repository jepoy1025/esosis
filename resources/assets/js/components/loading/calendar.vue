        ...
        <div class="col-lg-12">
          <div id='wrap' style="width: 100%;margin: 0;">
            ...
            <div id='external-events' style="    float: left;
              ...
              <div v-for="subject in resources" class='fc-event' :subject-id="subject.id" style="margin: 10px 0;cursor: pointer;">{{ subject.title }}</div>
              <p>
...
export default {
    ...
    methods: {
        ...
        // },
        loadRoom(){
            axios.get("api/room").then(({data})=>(this.resources = data.data)); 
        },
        loadSubject(){
